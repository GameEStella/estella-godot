...
void Shinobu::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("instantiate_phaser"), &Shinobu::instantiate_phaser);
...
Ref<ShinobuPhaserEffect> Shinobu::instantiate_phaser() {
    return memnew(ShinobuPhaserEffect(2));
}
